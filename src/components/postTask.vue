        ...
        <div class="right_align_style h_100 py-3 my-3" v-if="openMod.open === true">
            ...
            <div class="modal_fixed container" id="modal">
                ...
                <button @click="closeModal()" class="close_btn btn mt-2 mx-1">
                    <span style="color:red">Close</span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-x-circle" viewBox="0 0 16 16">
                ...
                <p class="small text-white my-3">Type in your id or another user's id <br /> or assign a task to your id</p>
